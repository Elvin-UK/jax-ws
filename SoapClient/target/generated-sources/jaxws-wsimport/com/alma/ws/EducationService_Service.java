 ...
 * 
 */
@WebServiceClient(name = "EducationService", targetNamespace = "http://education.ws.alma.com/", wsdlLocation = "http://localhost:8080/SoapService/EducationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EDUCATIONSERVICE_QNAME = new QName("http://education.ws.alma.com/", "EducationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapService/EducationService?wsdl");
    ...
    public EducationService getEducationServicePort() {
        return super.getPort(new QName("http://education.ws.alma.com/", "EducationServicePort"), EducationService.class);
    }
    ...
    public EducationService getEducationServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://education.ws.alma.com/", "EducationServicePort"), EducationService.class, features);
    }
